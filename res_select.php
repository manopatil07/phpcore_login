...
if(isset($_REQUEST["DeleteId"]))
{
    ...
    // echo $DELETE;
    // echo"<br>";
    $ImageNameFatchQuery=mysqli_query($connection,"SELECT*FROM registration WHERE id='$DELETE'");
    $ImageNameFatchdata=mysqli_fetch_array($ImageNameFatchQuery);
    $GetImageName=$ImageNameFatchdata["file_pisc"];
    // echo $GetImageName;

    $DELETEQUREY=mysqli_query($connection,"DELETE FROM registration WHERE id='$DELETE'");
        if($DELETEQUREY)
    {
        unlink("Ipisc/".$GetImageName);
        echo "data delete";
    }else 
    {
...
<body>
    ...
    <form method="post" action="search_name.php">
        Name : - <input type="text" name="search_by"><br><br>
...
<?php
    ...
    {
      $datafatch=  mysqli_fetch_array($select);
        ?>
    <tr>
